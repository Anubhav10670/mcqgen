...
const prompt = `I want you to generate ${numQuestions} multiple-choice quiz questions based on the following text. The output should be strictly in valid JSON format, containing only the questions, options, and correct answers. The JSON should be correct with no syntax errors and should avoid using backticks or any other formatting characters. Do not include any additional remarks, reasoning, or explanations—only the JSON output (the questions should be valuable and good with meaning not like , in the passage , in the page , explain the question well). Format the response as a JSON array where each question object follows this structure: {"question": "...", "options": ["...", "...", "...", "..."], "correctAnswer": "..."}. Ensure the JSON is valid and contains meaningful questions. Do not make any errors in the JSON file, and format it carefully , the output should be in text format dont box it. Text: ${text}`;
